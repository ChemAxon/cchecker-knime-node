...
public class OptionsTabFields {
    ...
    public OptionsTabFields(ConnectionSettingsTabFields connectionFields) {
        m_date = new SettingsModelDateOfRegulations(CFGKEY_DATE_OF_REGULATIONS, connectionFields);
    }
